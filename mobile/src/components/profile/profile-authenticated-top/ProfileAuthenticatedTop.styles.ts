...
export const t = StyleSheet.create({
  ...
  skRow: { flexDirection: "row", gap: spacing.md, alignSelf: "stretch" },
  skCard: { flex: 1, height: 70, borderRadius: radius.card, backgroundColor: colors.surface },
  hero: { alignItems: "center" },
  rainClip: { ...StyleSheet.absoluteFillObject, borderRadius: radius.card, overflow: "hidden" },
  ...
  name: { marginTop: spacing.md, color: colors.textPrimary, fontFamily: font.mono, fontSize: fontSize.lg, fontWeight: "800", alignSelf: "stretch", textAlign: "center" },
  email: { color: colors.textSecondary, marginTop: spacing.xs, alignSelf: "stretch", textAlign: "center" },
  meta: { color: colors.success, fontFamily: font.mono, fontSize: fontSize.sm, marginTop: spacing.sm, fontWeight: "700" },
  upCard: { backgroundColor: colors.card, borderRadius: radius.card, padding: spacing.xl, borderColor: colors.border, borderWidth: 1, flexDirection: "row", gap: spacing.sm, alignItems: "center" },
